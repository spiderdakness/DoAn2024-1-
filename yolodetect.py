...
class YoloDetect():
    def __init__(self, detect_class: object = "person", frame_width=1280, frame_height=720):

        # Parameters
        self.classnames_file = "classname.txt/labels.txt"
